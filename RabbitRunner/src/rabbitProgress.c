...
static const char* rabbit128 [3] = {
    " (\\_/)",
    "(='.'=)",
    "(\")_(\")"
};

static const char* rabbit256 [9] = {
    "   _     _     ",
    "   \\`\\ /`/   ",
    "    \\ V /     ",
    "    /. .\\     ",
...
static const char* rabbit1024 [19] = {
    "        /|      __    ",
    "       / |   ,-~ /    ",
    "      Y :|  //  /     ",
    "      | jj /( .^      ",
...
void
rabbitProgress_init(int maxValue, int rabbitSize)
{
    mMax = maxValue;
...
void 
rabbitProgress_progress(int pos)
{
